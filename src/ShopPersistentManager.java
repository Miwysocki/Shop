...
public class ShopPersistentManager extends PersistentManager {
	...
	private ShopPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(Customer.class);
		aMetadataSources.addAnnotatedClass(DeliveryAddress.class);
		aMetadataSources.addAnnotatedClass(Orders.class);
		aMetadataSources.addAnnotatedClass(OrderEntry.class);
		aMetadataSources.addAnnotatedClass(Product.class);
		aMetadataSources.addAnnotatedClass(Employee.class);
		aMetadataSources.addAnnotatedClass(Manufacturer.class);
		aMetadataSources.addAnnotatedClass(VatCategory.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ShopPersistentManager();
		}
